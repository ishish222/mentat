...
/** 
 *  SourceUnit: /Users/tsalacinski/Projects/2024-04-24-web3-incidents/ronin/replaying/src/contracts/flattened.sol
*/
...
<response>
    <thinking>
        ...
        <step num="2">I read through the code carefully</step>
        <step num="3">Identified the contract</step>
        <step num="4">Escaped the HTML characters</step>
        <step num="5">Extracted the source code in the requested format</step>
    </thinking>
    <components>
        <component>
            <name>MainchainGatewayManager</name>
            <source_code>
/**
 * @title MainchainGatewayManager
 * @dev Logic to handle deposits and withdrawl on Mainchain.
...
let extract_source_system_xml_str = `
...
<thinking_steps>
    ...
    <step num="3">Identify the contract</step>
    <step num="4">HTML escape characters '<', '>', '&'</step>
    <step num="5">Extract the source code</step>
</thinking_steps>
...
<response>
    ...
    <components>
        <component>
            ...
            <source_code>Source code of contract with escaped HTML characters</source_code>
        </component>
    </components>
</response>
\`\`\`
...
export const extract_source_prompt_xml = ChatPromptTemplate.fromMessages([
    ["system", extract_source_system_xml_str],
    ["human", extract_source_human_xml_str],
]);